...
// Detect the real file type by content rather than filename: .xlsx files are
// ZIP archives that start with the bytes "PK". Anything else — including a
// CS.Net CSV export whose extension was lost on upload — is treated as CSV.
// (Filename-based routing sent extension-less CSVs to the XLSX parser, which
// then read intake_number as the client name and threw bogus duplicate errors.)
